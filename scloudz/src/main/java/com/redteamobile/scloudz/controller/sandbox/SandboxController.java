package com.redteamobile.scloudz.controller.sandbox;
...
import com.redteamobile.scloudz.config.resource.CustomResource;
import com.redteamobile.scloudz.controller.BaseController;
import com.redteamobile.scloudz.model.page.ResponseStruct;
import com.redteamobile.scloudz.model.page.SwaggerSamplePage;
import com.redteamobile.scloudz.model.req.UserParam;
...
public class SandboxController extends BaseController {
    ...
    public ResponseStruct i18n() {
        // 尝试不抛出异常，来对比
        String slogan = localeMessageSource.getMessage("RT_SCLOUDZ_INFO_101");
