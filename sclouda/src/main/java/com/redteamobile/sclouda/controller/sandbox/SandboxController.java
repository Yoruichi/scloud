package com.redteamobile.sclouda.controller.sandbox;
...
import com.redteamobile.sclouda.config.resource.CustomResource;
import com.redteamobile.sclouda.controller.BaseController;
import com.redteamobile.sclouda.model.page.ResponseStruct;
import com.redteamobile.sclouda.model.page.SwaggerSamplePage;
...
public class SandboxController extends BaseController {
    ...
    public ResponseStruct i18n() {
        // 尝试不抛出异常，来对比
        String slogan = localeMessageSource.getMessage("RT_SCLOUDA_INFO_101");
