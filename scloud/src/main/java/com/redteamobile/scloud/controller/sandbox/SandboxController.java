package com.redteamobile.scloud.controller.sandbox;
...
import com.redteamobile.scloud.config.resource.CustomResource;
import com.redteamobile.scloud.controller.BaseController;
import com.redteamobile.scloud.model.page.ResponseStruct;
import com.redteamobile.scloud.model.page.SwaggerSamplePage;
import com.redteamobile.scloud.model.req.UserParam;
...
public class SandboxController extends BaseController {
    ...
    public ResponseStruct i18n() {
        // 尝试不抛出异常，来对比
        String slogan = localeMessageSource.getMessage("RT_SCLOUD_INFO_101");
