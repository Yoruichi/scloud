package com.redteamobile.scloudb.controller.sandbox;
...
import com.redteamobile.scloudb.config.resource.CustomResource;
import com.redteamobile.scloudb.controller.BaseController;
import com.redteamobile.scloudb.model.page.ResponseStruct;
import com.redteamobile.scloudb.model.page.SwaggerSamplePage;
...
public class SandboxController extends BaseController {
    ...
    public ResponseStruct i18n() {
        // 尝试不抛出异常，来对比
        String slogan = localeMessageSource.getMessage("RT_SCLOUDB_INFO_101");
